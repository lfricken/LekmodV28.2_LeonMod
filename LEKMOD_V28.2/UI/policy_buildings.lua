...
PolicyGrantsFreeBuilding(GameEvents, "POLICY_BRANCH_AUTOCRACY", "CAN_BUILD_FIREWALL");
PolicyGrantsFreeBuilding(GameEvents, "POLICY_BRANCH_ORDER", "CAN_BUILD_FIREWALL");
